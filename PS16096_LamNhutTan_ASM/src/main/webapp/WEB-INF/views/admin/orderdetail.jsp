	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="container col-12">
				<div class="col-6">
					<form:form action="/admin/orderdetail" modelAttribute="item">
						...
						<div class="form-group">
							<label for="exampleInputProductId">Quantity</label>
							<form:input type="text" class="form-control"
								id="exampleInputProductId" path="quantity" />
						</div>
						<div class="form-group">
						...
						<button type="submit" class="btn btn-danger">
							<a href="/admin/orderdetail/delete/${item.id}">Xóa</a>
						</button>
					</form:form>
				</div>
				<hr>
