		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="/admin/sortcategory" class="nav-link">Sort</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a
					href="/admin/pagecategory" class="nav-link">Page</a></li>
			</ul>
		...
		<div class="content-wrapper">
			<div class="container col-12">
					...
					<tbody>
						<c:forEach var="item" items="${page.content}">
							<tr>
								...
								<td>${item.name}</td>
								<td><a href="/admin/category/edit/${item.id}"><i
				...
				<div class="col-8 m-auto">
					...
					href="/admin/pagecategory?p=0" role="button">First</a> 
					<a class="btn btn-outline-primary"
						href="/admin/pagecategory?p=${page.number-1}" role="button">Previous</a>
					<a class="btn btn-outline-primary"
						href="/admin/pagecategory?p=${page.number+1}" role="button">Next</a>
					<a class="btn btn-outline-primary"
						href="/admin/pagecategory?p=${page.totalPages-1}" role="button">Last</a>
				</div>
				<div class="col-8 m-auto">
					<ul>
