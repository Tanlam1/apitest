		...
		<div class="content-wrapper">
			<div class="container col-12">
				<table class="table col-8 m-auto">
					<thead>
						<tr>
							<th scope="col"><a href="/admin/sortproduct?field=id">Id</th>
							<th scope="col"><a href="/admin/sortproduct?field=name">Name</th>
							<th scope="col"><a href="/admin/sortproduct?field=image">Image</th>
							<th scope="col"><a href="/admin/sortproduct?field=price">Price</th>
