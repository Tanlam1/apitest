		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a
					href="/admin/sortproduct" class="nav-link">Sort</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a
					href="/admin/pageproduct" class="nav-link">Page</a></li>
			</ul>
			<!-- SEARCH FORM -->
					...
					<form:form action="/admin/product" modelAttribute="item">
						<div class="form-group">
							...
							<form:input type="text" class="form-control"
								id="exampleInputName" path="name" />
						</div>
						<div class="form-group">
							<label for="exampleInputImage">Image</label>
							<form:input type="text" class="form-control"
								id="exampleInputImage" path="image" />
						</div>
						<div class="form-group">
							<label for="exampleInputPrice">Price</label>
							<form:input type="text" class="form-control"
								id="exampleInputPrice" path="price" />
						</div>
						<div class="form-group">
							<label for="exampleInputCrateDate">CrateDate</label>
							<form:input class="form-control" id="exampleInputCrateDate"
								path="createDate" />
						</div>
						<div class="form-group">
							<label for="exampleInputStatus">Status</label>
							<form:checkbox class="form-control" id="exampleInputStatus"
								path="available" />
						</div>
						...
						<button type="submit" class="btn btn-success"
							formaction="/admin/product/update">Sửa</button>
					</form:form>
				</div>
				<hr>
					...
					<tbody>
						<c:forEach var="item" items="${items}">
							<tr>
								...
								<td><a href="/admin/product/edit/${item.id}"><i
